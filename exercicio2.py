...
total = 0 #acumualador do carrinho 
...
while True: #laço de repetição para repetir os passos das perguntas ao usuário
    ...
    recomprar = input('Você deseja pedir mais alguma coisa?[S/N]') #Perguntamos o usuário se ele deseja adicionar mais coisas
    
    if(recomprar == 'S'): # Se comprar, ele volta ao começo do laço 
        continue
    elif (recomprar == 'N'): # Se ele digitar N, ele encerra o programa e mostra ao usuário total gasto
        ...
        print('Você digitou um caracter inválido e/ou esse código não existe {}'.format(total))    
